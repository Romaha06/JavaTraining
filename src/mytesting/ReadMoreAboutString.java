...
public class ReadMoreAboutString {
    ...
    public static void main(String[] args) {
        ...
        /*Тип String является не приметивным типом данных
          ...
          с приметивными типами данных это их сранение
          то есть если мы хотим сравнить строку с какой то
          другой строкой то в данном случае мы кже не можем
        ...
        s = "TeXt";
        System.out.println(s);//Получаем нашь оригинальный текст присвоеный переменной "s"
